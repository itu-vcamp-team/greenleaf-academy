...
export default function ReferenceCodeGenerator() {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-xl shadow-black/[0.02] relative overflow-hidden group">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
        ...
        <button
          ...
          disabled={loading}
          className="relative inline-flex items-center justify-center gap-3 bg-gray-900 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest
                     hover:bg-primary hover:scale-[1.02] active:scale-95 disabled:opacity-50 transition-all shadow-2xl shadow-black/10"
        >
          {loading ? (
      ...
      <AnimatePresence>
        {code && (
          ...
          >
            <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-inner">
               <div className="flex flex-col items-center sm:items-start">
                  <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Referans Kodunuz</span>
               ...
               <button
                 ...
                 className={`flex items-center gap-2 py-3 px-6 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all ${
                   copied 
                    ...
                    : "bg-white text-gray-900 border border-gray-200 hover:border-primary/30 hover:shadow-lg"
                 }`}
               >
            ...
            <p className="flex items-center justify-center sm:justify-start gap-2 text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-4 pl-2 opacity-60">
